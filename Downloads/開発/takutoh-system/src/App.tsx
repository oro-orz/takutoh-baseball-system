...
const AppContent: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case 'progress':
        return authState.isAdmin ? <ParticipationProgressPage /> : <ParticipationProgressPage />;
      case 'admin':
        return <GameRecordsPage isAdmin={authState.isAdmin} />;
      case 'game-records':
        return <GameRecordsPage isAdmin={authState.isAdmin} />;
      case 'profile':
        return authState.isAdmin ? <PlayerManagementPage /> : <MyPage />;
      case 'management':

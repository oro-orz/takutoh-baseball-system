...
-- 2. 保護者＋選手データの追加（playersフィールドにJSONBで選手情報を保存）
...
INSERT INTO users (pin, name, email, role, is_admin, players, created_at, updated_at) VALUES 
  ...
  ('1008', 'ユージ藤五郎', 'parent_1008@system.local', 'parent', false, '[{"id": "player_1008_1", "name": "伊藤五郎", "hiraganaName": "ごろう", "grade": 6, "position": "ユーティリティ"}]'::jsonb, NOW(), NOW()),
...
-- 4. 確認クエリ
SELECT '選手データ含むサンプルデータ追加完了' as status;

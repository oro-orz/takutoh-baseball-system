...
VALUES (
  'f1a2b3c4-d5e6-4f8g-9h0i-j1k2l3m4n5o6',
  '田中家',
  '1001',
  false,
  'tanaka@example.com',
...
INSERT INTO users (id, name, pin, is_admin, email, role, created_at, updated_at)
VALUES 
  ('a1b2c3d4-e5f6-4g8h-9i0j-k1l2m3n4o5p6', '佐藤家', '1002', false, 'sato@example.com', 'parent', NOW(), NOW()),
  ('b2c3d4e5-f6g7-4h9i-0j1k-l2m3n4o5p6q7', '鈴木家', '1003', false, 'suzuki@example.com', 'parent', NOW(), NOW()),
  ('c3d4e5f6-g7h8-4i0j-1k2l-m3n4o5p6q7r8', '高橋家', '1004', false, 'takahashi@example.com', 'parent', NOW(), NOW())
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
  pin = EXCLUDED.pin,
  is_admin = EXCLUDED.is_admin,

...
INSERT INTO users (pin, name, email, role, is_admin, players, created_at, updated_at) VALUES 
  ...
  ('1006', '高橋三郎', 'parent_1006@system.local', 'parent', false, '[{"id": "player_1006_1", "name": "高橋三郎", "hiraganaName": "さぶろう（て）”', "grade": 3, "position": "センター"}]'::jsonb, NOW(), NOW()),
  ...
  ('1014', '吉田十一', 'parent_1014@system.local', 'parent', false, '[{"id": "player_1014_1", "name": "吉田十一郎", "hiraganaName": "じゆういちろう", "grade": 5, "position": "メイン"}]'::jsonb, NOW(), NOW()),
  ('1015', '山本十二', 'parent_1015@system.local', 'parent', false, '[{"id": "player_1015_1", "name": "山本十二郎", "hiraganaName": "じゆうにろう", "grade": 6, "position": "キャプテン"}]'::jsonb, now(), NOW());
...
-- 6. 確認クエリ
SELECT '完全なサンプルデータ追加完了' as status;

...
INSERT INTO users (pin, name, email, role, is_admin, players, created_at, updated_at) VALUES (
  ...
  'parent', 
  false,
  '[{"id": "player_1001_1", "name": "田中次郎", "hiraganaName": "じろう", "grade": 6, "position": "ピッチャー"}, {"id": "player_1001_2", "name": "田中花子", "hiraganaName": "はなこ", "grade": 4, "position": "キャッチャー"}]'::jsonb,
  NOW(), 
  NOW()
);
...
INSERT INTO users (pin, name, email, role, is_admin, players, created_at, updated_at) VALUES (
  ...
  'parent', 
  false,
  '[{"id": "player_1004_1", "name": "佐藤二郎", "hiraganaName": "じろうさ", ", grade": 4, "position": "セカンド"}, {"id": "player_1004_2", "name": "佐藤さくら", "hiraganaName": "さくらさ", "grade": 2, "position": "サード"}]'::jsonb,
  NOW(), 
  NOW()
);
...
INSERT INTO users (pin, name, email, role, is_admin, players, created_at, updated_at) VALUES 
  ...
  ('1006', '高橋三郎', 'parent_1006@system.local', 'parent', false, '[{"id": "player_1006_1", "name": "高橋三郎", "hiraganaName": "さぶろう", "grade": 3, "position": "センター"}]'::jsonb, NOW(), NOW()),
...
-- 5. 確認
SELECT 'クリーンサンプルデータ完了' as status;
